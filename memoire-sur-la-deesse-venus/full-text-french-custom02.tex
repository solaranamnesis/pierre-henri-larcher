...
% change color of text, example replace all \color{Silver} with \color{lightgray}
\definecolor{moon}{RGB}{245, 243, 206}

\makeatletter % change only the display of \thepage, but not \thepage itself:
\patchcmd{\ps@plain}{\thepage}{\Fontlukas\bfseries\color{moon}{\thepage}}{}{}
\makeatother
...
\renewcommand\thefootnote{{\Fontlukas\bfseries\color{Goldenrod}{\arabic{footnote}}}}
\let\oldfootnote\footnote
    \renewcommand{\footnote}[1]{\oldfootnote{{\normalsize\Fontlukas\bfseries\color{Goldenrod}#1}}}
...
\clearpage
\subsection*{\Large\Fontlukas\bfseries Des Auteurs et des Editions dont je me suis servi.}
\paragraph{}
\begin{itemize}
